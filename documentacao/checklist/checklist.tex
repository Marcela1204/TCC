...
\item \textbf{Alunos:}
\begin{itemize}
    \item Fulano Silva (RA: 888-37)
    \item Cicrano Silva (RA: 888-98)
    \item Gracriana Silva (RA:999-99)
\end{itemize}
\item \textbf{Orientador:} Prof. Dra. Leila Cristina C. Bergamasco
...
\item \textbf{CA2330 Teoria dos Grafos :} O conceitos de arestas e caminhos entre grafos pode ser relevante para compreender os agrupamentos de usuários e suas respectivas relações com problemas de saúde mental.
\item \textbf{CC4670 Computação Móvel:} Como estamos avaliando a implementação de um app de monitoramento da saúde mental, os conceitos de A, B e C vistos na disciplina podem ser uteis para o nosso projeto.
...
\item \textbf{CC8550 Simulação e Teste de Software: }Pela ementa descrita no site e conversando com alunos que estão cursando essa disciplina, eles comentaram que existirão tópicos de testes unitários que parecem ser aderentes ao nosso tema.
\end{itemize}
\end{document}
